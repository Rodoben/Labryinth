        ...
        newPostBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(desc) && !TextUtils.isEmpty(title) && postImageUri!=null){
                    ...
                    StorageReference filepath=storageReference.child("event_images").child(randomName+".jpg");
                    ...
                    filepath.putFile(postImageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull final Task<UploadTask.TaskSnapshot> task) {
                            ...
                            if (task.isSuccessful()){
                                ...
                                UploadTask uploadTask=storageReference.child("event_images/thumbs")
                                ...
                                uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                    ...
                                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                        ...
                                        firebaseFirestore.collection("event").add(postMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                            @Override
                                            public void onComplete(@NonNull Task<DocumentReference> task) {
                                                if (task.isSuccessful()){
                                                    Toast.makeText(getApplicationContext(),"Post was Added",Toast.LENGTH_SHORT).show();
